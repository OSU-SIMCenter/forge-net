...
class CondResPCTransitionModel(nn.Module):
    def __init__(self, point_size, latent_size, action_dims, dropout=0.3):
        super(CondResPCTransitionModel, self).__init__()
        self.latent_size = int(latent_size / 2)
        self.point_size = point_size
        self.dropout = dropout
        ...
        # ====================================================================
        # POINT-WISE DECODER (Critical Change)
    ...
    def state_encoder(self, x):
        ...
        # Global Max Pooling to get shape context
    ...
    def decoder(self, combined_features):
        """
